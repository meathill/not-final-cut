...
async function stt(mp3) {
  ...
  const filename = mp3.substring(mp3.lastIndexOf('/'));
  await oss.put(filename, mp3);
  ...
  let task = {
    appkey : aliyunAppKey,
    file_link : 'https://alicdn.meathill.com/' + filename,
    version : "4.0",
    enable_words : true,
  };
